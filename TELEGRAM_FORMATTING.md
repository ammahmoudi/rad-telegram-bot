...
## Quick Reference for HTML Mode (Our Bot Uses This)
...
**Important:**
- ❌ DO NOT use `**text**` or `__text__` - these are Markdown, not HTML!
- ❌ DO NOT use `*text*` or `_text_` - these are Markdown, not HTML!
- ✅ Always use proper HTML tags when `parse_mode: 'HTML'` is set
- ✅ Escape `<`, `>`, `&` as `&lt;`, `&gt;`, `&amp;` when not part of tags
